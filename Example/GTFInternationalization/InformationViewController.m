...
- (void)viewDidLoad {
  ...
  UIImage *flippedImage = [standardImage gtf_imageWithHorizontallyFlippedOrientation];
  UIImage *twiceFlippedImage = [flippedImage gtf_imageWithHorizontallyFlippedOrientation];
